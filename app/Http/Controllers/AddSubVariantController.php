...
class AddSubVariantController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($file = $request->file('image1'))
        {
            ...
            {
                $image = @file_get_contents(public_path() . '/images/variantimages/' . $varimage->image1);
        ...
        if ($file = $request->file('image2'))
        {
            ...
            {
                $image = @file_get_contents(public_path() . '/images/variantimages/' . $varimage->image2);
        ...
        if ($file = $request->file('image3'))
        {
            ...
            {
                $image = @file_get_contents(public_path() . '/images/variantimages/' . $varimage->image3);
        ...
        if ($file = $request->file('image4'))
        {
            ...
            {
                $image = @file_get_contents(public_path() . '/images/variantimages/' . $varimage->image4);
        ...
        if ($file = $request->file('image5'))
        {
            ...
            {
                $image = @file_get_contents(public_path() . '/images/variantimages/' . $varimage->image5);
        ...
        if ($file = $request->file('image6'))
        {
            ...
            {
                $image = @file_get_contents(public_path() . '/images/variantimages/' . $varimage->image6);
