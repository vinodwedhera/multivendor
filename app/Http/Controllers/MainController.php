...
class MainController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $slider = $sliderquery->where('status', '1')->get();
    ...
    public function categoryf(Request $request)
    {
        ...
        if($cur_change == 'yes'){
            ...
            if ($connected){
                ...
                $defcurrate = 1; 
                notify()->error('Connection not found ! currencey conversion need active internet connection');
            }

            $defcurrate = round($defcurrate, 4);
